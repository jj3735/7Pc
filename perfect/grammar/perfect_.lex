...
<YYINITIAL> "then" { return new RawToken("then",yytext(),yyline,yychar-line_char,yychar); }
...
<YYINITIAL> "export" { return new RawToken("export",yytext(),yyline,yychar-line_char,yychar); }
